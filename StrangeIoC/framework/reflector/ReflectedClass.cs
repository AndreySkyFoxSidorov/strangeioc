...
public class ReflectedClass : IReflectedClass
{
	...
	public ConstructorInfo constructor { get => Constructor; set => Constructor = value; }
	public Type[] constructorParameters { get => ConstructorParameters; set => ConstructorParameters = value; }
	public MethodInfo[] postConstructors { get => PostConstructors; set => PostConstructors = value; }
	public KeyValuePair<Type, PropertyInfo>[] setters { get => Setters; set => Setters = value; }
	public object[] setterNames { get => SetterNames; set => SetterNames = value; }
	public bool preGenerated { get => PreGenerated; set => PreGenerated = value; }
}
}
